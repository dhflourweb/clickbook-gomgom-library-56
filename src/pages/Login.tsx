...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-primary-deepblue to-primary-realblue py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center text-sm text-white/70">
          <p>
            © 2024 곰클릭+책방. All rights reserved.
          </p>
        </div>
      </div>
    </div>
